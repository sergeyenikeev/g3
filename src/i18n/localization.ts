...
const MESSAGES: Record<Locale, Record<string, MessageValue>> = {
  ...
  ru: {
    ...
    "menu.dailyRewarded": "СМОТРЕТЬ РЕКЛАМУ И ОТКРЫТЬ ДЕЙЛИК",
    "menu.dailyLocked": "ЕЖЕДНЕВКА (закрыта)",
    "menu.dailyBoost": "СМОТРЕТЬ РЕКЛАМУ И ОТКРЫТЬ ДЕЙЛИК + БОНУС",
    "menu.dailyBoostExtra": "СМОТРЕТЬ РЕКЛАМУ И ОТКРЫТЬ ДОП. ДЕЙЛИК + БОНУС",
    "menu.dailyBoostLocked": "ДЕЙЛИК + БОНУС ЗАКРЫТ",
