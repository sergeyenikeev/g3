...
const MESSAGES: Record<Locale, Record<string, MessageValue>> = {
  en: {
    ...
    "bootstrap.loading.title": "Magnet Caravan",
    "bootstrap.loading.body": "Preparing the route, events, and controls.",
    "bootstrap.loading.progress": (p) => `Loading ${p?.value ?? 0}%`,
    "bootstrap.fatal.title": "Restart Magnet Caravan",
    "bootstrap.fatal.body": "The game ran into an unexpected issue. Reload the page and try again.",
    "bootstrap.fatal.action": "Reload",
    "menu.workshop": "WORKSHOP",
    "menu.play": "PLAY",
    "menu.playBoost": "WATCH AD & START WITH BONUS",
    "menu.training": "TRAINING",
    "menu.daily": "DAILY",
    "menu.dailyFree": "DAILY (Free)",
    "menu.dailyRewarded": "WATCH AD & OPEN DAILY RUN",
    "menu.dailyLocked": "DAILY (Locked)",
    "menu.dailyBoost": "WATCH AD & OPEN DAILY + BONUS",
    "menu.dailyBoostExtra": "WATCH AD & OPEN EXTRA DAILY + BONUS",
    "menu.dailyBoostLocked": "DAILY + BONUS LOCKED",
    "menu.playFreeBoost": (p) => `PLAY + FREE BOOST (${p?.usesLeft ?? 0} left)`,
    "menu.playFreeBoostHint": (p) => `Free boost ready | ${p?.usesLeft ?? 0} left`,
    "menu.playRewardedBoostHint": "Start bonus is on",
    ...
    "pause.hint": "Run paused. Settings apply immediately.",
    "pause.resume": "RESUME",
    "pause.menu": "MENU",
    "results.title": "RUN OVER",
    "results.boost": (p) => `WATCH AD & DOUBLE REWARD x${p?.mult ?? "2"}`,
    ...
    "hud.bolts": "Bolts",
    "hud.goal": "Goal",
    "hud.moreStatuses": (p) => `+${p?.count ?? 0} more`,
    "results.cores": "Cores",
    ...
    "tutorial.step2": "Use FLIP to push enemies away and reflect shots.",
    "tutorial.step3": "Bank your tail in the Recycler Zone.",
    "revive.title": "REVIVE?",
    "revive.hint": "Watch an ad to continue this run.",
  ...
  ru: {
    "app.title": "Magnet Caravan",
    "bootstrap.loading.title": "Magnet Caravan",
    "bootstrap.loading.body": "Подготавливаем маршрут, события и управление.",
    "bootstrap.loading.progress": (p) => `Загрузка ${p?.value ?? 0}%`,
    "bootstrap.fatal.title": "Перезапустите Magnet Caravan",
    "bootstrap.fatal.body": "Во время запуска произошёл сбой. Перезагрузите страницу и попробуйте снова.",
    "bootstrap.fatal.action": "Перезагрузить",
    "menu.workshop": "МАСТЕРСКАЯ",
    "menu.play": "ИГРАТЬ",
    "menu.playBoost": "СМОТРЕТЬ РЕКЛАМУ И СТАРТОВАТЬ С БОНУСОМ",
    "menu.training": "ОБУЧЕНИЕ",
    "menu.daily": "ЕЖЕДНЕВКА",
    "menu.dailyFree": "ЕЖЕДНЕВКА (бесплатно)",
    "menu.dailyRewarded": "СМОТРЕТЬ РЕКЛАМУ И ОТКРЫТЬ ЕЖЕДНЕВНЫЙ ЗАЕЗД",
    "menu.dailyLocked": "ЕЖЕДНЕВКА (закрыта)",
    "menu.dailyBoost": "СМОТРЕТЬ РЕКЛАМУ И ОТКРЫТЬ ЕЖЕДНЕВНЫЙ ЗАЕЗД + БОНУС",
    "menu.dailyBoostExtra": "СМОТРЕТЬ РЕКЛАМУ И ОТКРЫТЬ ДОП. ЕЖЕДНЕВНЫЙ ЗАЕЗД + БОНУС",
    "menu.dailyBoostLocked": "ЕЖЕДНЕВНЫЙ ЗАЕЗД + БОНУС ЗАКРЫТ",
    "menu.playFreeBoost": (p) => `ИГРАТЬ + БЕСПЛАТНЫЙ БУСТ (${p?.usesLeft ?? 0} ост.)`,
    "menu.playFreeBoostHint": (p) => `Бесплатный буст готов | ${p?.usesLeft ?? 0} ост.`,
    "menu.playRewardedBoostHint": "Бонус к старту включён",
    ...
    "menu.nextDailyFree": "Следующий ежедневный заезд: бесплатный старт.",
    "menu.nextDailyRewarded": "Следующий ежедневный заезд: дополнительная попытка за рекламу.",
    "menu.nextDailyUnavailable": "Следующий ежедневный заезд: стартов на сегодня больше нет.",
    "menu.boostDailyDisabled": "Буст ежедневного заезда: отключён.",
    "menu.boostDailyFree": "Буст ежедневного заезда: одна реклама даст стартовый бонус.",
    "menu.boostDailyRewarded": "Буст ежедневного заезда: одна реклама даст бонус и израсходует доп. попытку.",
    "menu.boostDailyUnavailable": "Буст ежедневного заезда: сегодня недоступен.",
    ...
    "pause.hint": "Заезд на паузе. Настройки применяются сразу.",
    ...
    "hud.bolts": "Болты",
    "hud.goal": "\u0426\u0435\u043b\u044c",
    "hud.moreStatuses": (p) => `+ещё ${p?.count ?? 0}`,
    "results.cores": "\u042f\u0434\u0440\u0430",
    ...
    "tutorial.step2": "Используй ФЛИП, чтобы оттолкнуть врагов и отбить выстрелы.",
    "tutorial.step3": "Сдай хвост в зону переработчика.",
    "revive.title": "ПРОДОЛЖИТЬ?",
    "revive.hint": "Посмотри рекламу, чтобы продолжить заезд.",
...
Object.assign(MESSAGES.en, {
  ...
  "menu.rewardedDailyCta": (p?: Record<string, unknown>) => `WATCH AD\nDAILY BONUS: ${p?.reward ?? ""}`,
  "menu.startBoosterToggleTitle": "AD START BONUS",
  "menu.startBoosterToggleHint": (p?: Record<string, unknown>) => `Watch ad to add: ${p?.reward ?? ""}`,
  "menu.startBoosterToggleHintCompact": (p?: Record<string, unknown>) => `Ad bonus: ${p?.reward ?? ""}`,
...
Object.assign(MESSAGES.ru, {
  ...
  "menu.rewardedDailyCta": (p?: Record<string, unknown>) =>
    `\u0421\u041c\u041e\u0422\u0420\u0415\u0422\u042c \u0420\u0415\u041a\u041b\u0410\u041c\u0423\n\u0411\u041e\u041d\u0423\u0421 \u0414\u0415\u0419\u041b\u0418\u041a\u0410: ${p?.reward ?? ""}`,
  "menu.startBoosterToggleTitle": "\u0421\u0422\u0410\u0420\u0422\u041e\u0412\u042b\u0419 \u0411\u041e\u041d\u0423\u0421 \u0417\u0410 \u0420\u0415\u041a\u041b\u0410\u041c\u0423",
